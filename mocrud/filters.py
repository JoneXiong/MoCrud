...
from mocrud.forms import BaseModelConverter
from peewee import *
    ...
    def parse_query_filters(self):
        ...
        def _dfs(node, prefix, models, join_columns):
            for field in node.fields:
                ...
                if qf_select in request.params and qf_value in request.params:
                    accum.setdefault(field, [])
                    accum[field].append((
                        request.params.getall(qf_select),
                        request.params.getall(qf_value),
                        models,
                        join_columns,
                        qf_select,
                        qf_value,
